...
export const getVaultFirstPayouts  = ()   => Promise.resolve(sqlite.getVaultFirstPayouts?.() ?? []);
...
export const getPlayerRecentMissionStats    = () => Promise.resolve([]);
...
export async function getMissionStats() { return []; }
export async function getDistinctMintHashes() { return []; }
export async function batchUpdateMintOpTypes() { return 0; }
